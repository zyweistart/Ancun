...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if(self){
        ...
        [self.tfPhone setKeyboardType:UIKeyboardTypeNamePhonePad];
        ...
        [self.tfCode setKeyboardType:UIKeyboardTypeNumbersAndPunctuation];
...
- (void)goOK:(id)sender
{
    if([self.delegate respondsToSelector:@selector(accidentCerViewOK:)]){
        [self.delegate accidentCerViewOK:sender];
    }
}
