...
- (void)initControlBtn {
    UIView *bottomView=[[UIView alloc]initWithFrame:CGRectMake(0, self.view.frame.size.height - CGHeight(40), CGWidth(320), CGHeight(40))];
    [bottomView setBackgroundColor:[UIColor blackColor]];
    [self.view addSubview:bottomView];
    UIButton *bCancel=[[UIButton alloc]initWithFrame:CGRectMake1(0, 0, 50, 40)];
    [bCancel setTitle:@"取消" forState:UIControlStateNormal];
    [bCancel setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [bCancel.titleLabel setFont:[UIFont systemFontOfSize:Font1(16)]];
    [bCancel addTarget:self action:@selector(cancel:) forControlEvents:UIControlEventTouchUpInside];
    [bottomView addSubview:bCancel];
    UIButton *bOK=[[UIButton alloc]initWithFrame:CGRectMake1(240, 0, 80, 40)];
    [bOK setTitle:@"选取" forState:UIControlStateNormal];
    [bOK setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [bOK.titleLabel setFont:[UIFont systemFontOfSize:Font1(16)]];
    [bOK addTarget:self action:@selector(confirm:) forControlEvents:UIControlEventTouchUpInside];
    [bottomView addSubview:bOK];
}
