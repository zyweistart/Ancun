...
- (void)calculate {
	if (!caption || [caption isEqualToString:@""]) {
        ...
        NSDictionary *attribute = @{NSFontAttributeName:[UIFont boldSystemFontOfSize:14],NSParagraphStyleAttributeName:paragraphStyle};
        CGSize captionSize = [caption boundingRectWithSize:CGSizeMake(160, 200) options: NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:attribute context:nil].size;
//		CGSize captionSize = [caption sizeWithFont:[UIFont boldSystemFontOfSize:14] constrainedToSize:CGSizeMake(160, 200) lineBreakMode:NSLineBreakByWordWrapping];
		...
		if (fixedSize.width > 0 & fixedSize.height > 0) {
            ...
            paragraphStyle.lineBreakMode = NSLineBreakByWordWrapping;
            NSDictionary *attribute = @{NSFontAttributeName:[UIFont boldSystemFontOfSize:14],NSParagraphStyleAttributeName:paragraphStyle};
            captionSize = [caption boundingRectWithSize:CGSizeMake(s.width-p.margin*2, 200) options: NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:attribute context:nil].size;
//			captionSize = [caption sizeWithFont:[UIFont boldSystemFontOfSize:14] constrainedToSize:CGSizeMake(s.width-p.margin*2, 200) lineBreakMode:NSLineBreakByWordWrapping];
			...
			if (p.accessoryPosition == ATMHudAccessoryPositionTop || p.accessoryPosition == ATMHudAccessoryPositionBottom) {
				if (progress > 0) {
					...
					if (captionSize.width+p.margin*2 < progressRect.size.width) {
                        ...
                        paragraphStyle.lineBreakMode = NSLineBreakByWordWrapping;
                        NSDictionary *attribute = @{NSFontAttributeName:[UIFont boldSystemFontOfSize:14],NSParagraphStyleAttributeName:paragraphStyle};
                        captionSize = [caption boundingRectWithSize:CGSizeMake(progressRect.size.width, 200) options: NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:attribute context:nil].size;
//						captionSize = [caption sizeWithFont:[UIFont boldSystemFontOfSize:14] constrainedToSize:CGSizeMake(progressRect.size.width, 200) lineBreakMode:NSLineBreakByWordWrapping];
						captionRect.size = captionSize;
...
//						captionSize = [caption sizeWithFont:[UIFont boldSystemFontOfSize:14] constrainedToSize:CGSizeMake(progressRect.size.width, 200) lineBreakMode:NSLineBreakByWordWrapping];
				...
				if (marginX < p.margin) {
                    ...
                    paragraphStyle.lineBreakMode = NSLineBreakByWordWrapping;
                    NSDictionary *attribute = @{NSFontAttributeName:[UIFont boldSystemFontOfSize:14],NSParagraphStyleAttributeName:paragraphStyle};
                    captionSize = [caption boundingRectWithSize:CGSizeMake(160, 200) options: NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:attribute context:nil].size;
                    
                    
                    
//					captionSize = [caption sizeWithFont:[UIFont boldSystemFontOfSize:14] constrainedToSize:CGSizeMake(160, 200) lineBreakMode:NSLineBreakByWordWrapping];
					captionRect.size = captionSize;
...
- (CGSize)calculateSizeForQueueItem:(ATMHudQueueItem *)item {
	...
	if (!item.caption || [item.caption isEqualToString:@""]) {
        ...
        paragraphStyle.lineBreakMode = NSLineBreakByWordWrapping;
        NSDictionary *attribute = @{NSFontAttributeName:[UIFont boldSystemFontOfSize:14],NSParagraphStyleAttributeName:paragraphStyle};
        CGSize captionSize = [item.caption boundingRectWithSize:CGSizeMake(160, 200) options: NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:attribute context:nil].size;
        
//		CGSize captionSize = [item.caption sizeWithFont:[UIFont boldSystemFontOfSize:14] constrainedToSize:CGSizeMake(160, 200) lineBreakMode:NSLineBreakByWordWrapping];
		float adjustment = 0;
		CGFloat marginX = 0;
		CGFloat marginY = 0;
		if (!hasFixedSize) {
			...
			if (item.accessoryPosition == ATMHudAccessoryPositionTop || item.accessoryPosition == ATMHudAccessoryPositionBottom) {
				...
				if (marginX < p.margin) {
                    ...
                    paragraphStyle.lineBreakMode = NSLineBreakByWordWrapping;
                    NSDictionary *attribute = @{NSFontAttributeName:[UIFont boldSystemFontOfSize:14],NSParagraphStyleAttributeName:paragraphStyle};
                    captionSize = [item.caption boundingRectWithSize:CGSizeMake(160, 200) options: NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:attribute context:nil].size;
                    
//					captionSize = [item.caption sizeWithFont:[UIFont boldSystemFontOfSize:14] constrainedToSize:CGSizeMake(160, 200) lineBreakMode:NSLineBreakByWordWrapping];
