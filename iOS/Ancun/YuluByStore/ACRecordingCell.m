...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        _lblOppno=[[UILabel alloc]initWithFrame:CGRectMake1(10, 10, 183, 21)];
        [_lblOppno setFont:[UIFont systemFontOfSize:19]];
        [_lblOppno setTextColor:FONTCOLOR1];
        [self addSubview:_lblOppno];
        _lblLcalltime=[[UILabel alloc]initWithFrame:CGRectMake1(200, 19, 100, 21)];
        ...
        _lblRtcount=[[UILabel alloc]initWithFrame:CGRectMake1(14, 34, 75, 21)];
        [_lblRtcount setFont:[UIFont systemFontOfSize:15]];
        [_lblRtcount setTextColor:FONTCOLOR2];
        [self addSubview:_lblRtcount];
        _lblOrttime=[[UILabel alloc]initWithFrame:CGRectMake1(97, 34, 95, 21)];
