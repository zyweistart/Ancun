...
- (id)initWithLoad:(BOOL)load fileNo:(NSString *)fileNo extractionDics:(NSMutableDictionary*)dics
{
    ...
    if (self) {
        ...
        _lblAccendcode=[[UILabel alloc]initWithFrame:CGRectMake1(90, 0, 200, 41.5)];
        ...
        lbl=[[UILabel alloc]initWithFrame:CGRectMake1(20, 41.5, 75, 41.5)];
        [lbl setFont:[UIFont systemFontOfSize:17]];
        [lbl setTextAlignment:NSTextAlignmentLeft];
        [lbl setTextColor:[UIColor whiteColor]];
        [lbl setBackgroundColor:[UIColor clearColor]];
        ...
        _lblAccendtime=[[UILabel alloc]initWithFrame:CGRectMake1(90, 41.5, 200, 41.5)];
        ...
        lbl=[[UILabel alloc]initWithFrame:CGRectMake1(10, 103, 271, 90)];
        [lbl setFont:[UIFont systemFontOfSize:17]];
        [lbl setTextAlignment:NSTextAlignmentLeft];
        [lbl setTextColor:[UIColor whiteColor]];
        [lbl setBackgroundColor:[UIColor clearColor]];
        ...
        lbl=[[UILabel alloc]initWithFrame:CGRectMake1(10, 215, 271, 20)];
