...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        _lblName=[[UILabel alloc]initWithFrame:CGRectMake1(10, 4, 195, 24)];
        [_lblName setFont:[UIFont systemFontOfSize:19]];
        [_lblName setTextColor:FONTCOLOR1];
        [self addSubview:_lblName];
        _lblOppno=[[UILabel alloc]initWithFrame:CGRectMake1(14, 28, 136, 21)];
        [_lblOppno setFont:[UIFont systemFontOfSize:17]];
        [_lblOppno setTextColor:FONTCOLOR1];
        [self addSubview:_lblOppno];
        _lblLcalltime=[[UILabel alloc]initWithFrame:CGRectMake1(200, 26, 100, 21)];
        ...
        _lblRtcount=[[UILabel alloc]initWithFrame:CGRectMake1(14, 51, 75, 21)];
        [_lblRtcount setFont:[UIFont systemFontOfSize:15]];
        [_lblRtcount setTextColor:FONTCOLOR2];
        [self addSubview:_lblRtcount];
        _lblOrttime=[[UILabel alloc]initWithFrame:CGRectMake1(97, 51, 112, 21)];
