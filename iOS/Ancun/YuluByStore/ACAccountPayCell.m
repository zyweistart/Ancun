...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        _lblName=[[UILabel alloc]initWithFrame:CGRectMake1(10, 5, 180, 30)];
...
//        [_lblName setText:@"基础套餐"];
        ...
        _lblInfo=[[UILabel alloc]initWithFrame:CGRectMake1(10, 35, 180, 30)];
...
//        [_lblInfo setText:@"1分钟 2MB"];
        ...
        if([@"ACAccountPayCell" isEqualToString:reuseIdentifier]) {
            UILabel *lblStart=[[UILabel alloc]initWithFrame:CGRectMake1(195, 5, 35, 30)];
            [lblStart setFont:[UIFont systemFontOfSize:15]];
            [lblStart setTextColor:FONTCOLOR1];
            [lblStart setText:@"生效"];
            [self addSubview:lblStart];
            _lblStartTime=[[UILabel alloc]initWithFrame:CGRectMake1(230, 5, 80, 30)];
...
//            [_lblStartTime setText:@"2013-08-06"];
            ...
            UILabel *lblEnd=[[UILabel alloc]initWithFrame:CGRectMake1(195, 35, 35, 30)];
            [lblEnd setFont:[UIFont systemFontOfSize:15]];
            [lblEnd setTextColor:FONTCOLOR1];
            [lblEnd setText:@"到期"];
            [self addSubview:lblEnd];
            _lblEndTime=[[UILabel alloc]initWithFrame:CGRectMake1(230, 35, 80, 30)];
...
//            [_lblEndTime setText:@"2013-09-06"];
            ...
            UILabel *lblTimeLong=[[UILabel alloc]initWithFrame:CGRectMake1(250, 20, 60, 30)];
